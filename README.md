...
6. (Optional) You can install the "Fasteners" sample decal assets and/or sample "Spawner" script from the package manager window. I recommend getting the fastener decals so you can quickly start testing.
